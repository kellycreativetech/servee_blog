...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('biblion_section', 'content', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Section.content'
        db.delete_column('biblion_section', 'content')
